...
<form action="tambahdata.php" method="post" name="form1" enctype="multipart/form-data">

<p class="persyaratan" >Kode Anggota<br>
<input type="text" name="kode_destinasi" placeholder="masukan Kode destinasi.." /></p>

<p class="persyaratan" >Nama </br>
<input type="text" name="nama_destinasi" placeholder="masukan nama.." /></p>

<p class="persyaratan" >Jenis Kelamin</br>
<input type="text" name="harga_tiket" placeholder="masukan harga.." /></p>
<p class="persyaratan" >Kelas</br>
<input type="text" name="propinsi" placeholder="masukan harga.." /></p>
<p class="persyaratan">Alamat</br>
<textarea name="alamat" rows="5" cols="50" class="alamat" placeholder="masukan alamat.." ></textarea></p>

<p class="persyaratan" >Foto Anggota</br>
<input type="file" name="gbr"><br></p>
      
<p class="persyaratan">
<input type="submit" name="Submit" value="TAMBAH"></p>
</div>
</div>
</form>
</div>
